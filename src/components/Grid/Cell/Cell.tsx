...
import { Cell as CellType, Coords, CellState } from '@/types'
import { colors, transparent } from '@/helpers/colors'
...
export const Cell: FC<CellProps> = (props: CellProps) => {
  const { children, coords, ...rest } = props
  ...
  return <ComponentsMap {...innerProps}>{children}</ComponentsMap>
}
